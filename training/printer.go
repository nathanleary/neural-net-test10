...
func (p *StatsPrinter) PrintProgress(n *deep.Neural, validation model.Examples, elapsed time.Duration, iteration int) {
...
func formatAccuracy(n *deep.Neural, validation model.Examples) string {
	if n.Config.Mode == deep.ModeMultiClass {
...
func accuracy(n *deep.Neural, validation model.Examples) float32 {
	correct := 0
...
func crossValidate(n *deep.Neural, validation model.Examples) float32 {
